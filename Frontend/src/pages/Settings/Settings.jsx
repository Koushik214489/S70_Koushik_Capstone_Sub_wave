            ...
            <AnimatePresence mode="wait">
              ...
              {activeTab === 'billing' && (
                ...
                >
                  ...
                  <div className="p-6 bg-gradient-to-r from-purple-900/40 to-cyan-900/40 border border-secondary/30 rounded-2xl flex items-center justify-between">
                    <div>
                      <span className="px-2 py-1 text-[10px] uppercase font-bold tracking-wider bg-secondary/20 text-purple-300 rounded-md border border-secondary/30">Current Plan</span>
